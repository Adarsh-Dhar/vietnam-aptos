...
export async function POST(request: NextRequest) {
  try {
    console.log('=== Memecoin Save API Request ===');
    console.log('📥 Received POST request to /api/memecoin/save');
    ...
    console.log('=== Memecoin Storage Complete ===');
    ...
    console.error('Memecoin save error:', error);
    return NextResponse.json(
